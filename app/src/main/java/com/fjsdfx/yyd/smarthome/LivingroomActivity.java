    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler(){
            ...
            public void handleMessage(Message msg) {
                if(msg.what == 0x135){
                    temp.setText(MainActivity.livingroom.getTemp()+"");
                    humi.setText(MainActivity.livingroom.getHumi()+"");
                    if(MainActivity.livingroom.getLight() != LampStatus) {
                        if (MainActivity.livingroom.getLight() == 1) {
                    ...
                    if(MainActivity.livingroom.getCurtion() != CurtainStatus) {
                        if (MainActivity.livingroom.getCurtion() == 1) {
